const IntroEn = () => {
  return (
    <>
      ...
      <p>
        The barometer uses the annual average temperature as an indicator of
        ...
        <ul>
          ...
          <li>
            ...
            greenhouse gas emission reduction scenarios (blue, yellow, and red
            lines).
          </li>
        </ul>
      </p>
