    ...
    return (
        <>
            <div>
                ...
                <p>
                    Il barometro del clima, analogamente al barometro che misura la
                    pressione atmosferica usato per descrivere e prevedere l'evoluzione
                    meteorologica, vuole essere uno strumento semplice e diretto per
                    descrivere e prevedere il clima che cambia.
                </p>
                <p>
